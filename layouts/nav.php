...
/*
foreach($allUsersArray as $index => $value)
{
    print_r("category name = $value[name_en] <br>");
}
die;
*/
                            ...
                            <div class="main-menu">
                                <nav>
                                    <ul>
                                        ...
                                        <li class="mega-menu-position top-hover"><a href="shop.php?subCategoryId=1">shop</a>
                                            <ul class="mega-menu">
                                                

                                                <?php  
                                                
                                                foreach($allCategoriesArray as $index => $value)
                                                {
                                                    $subcategory->setId($value["id"]);
                                                    $allSubCategories = $subcategory->read();
                                                    $allSubCategoriesArray = $allSubCategories->fetch_all(MYSQLI_ASSOC);
                                                ?>
                                                ...
                                                <li>
                                                    <ul>
                                                        ...
                                                        <?php  
                                                            foreach($allSubCategoriesArray as $a => $b){
                                                        ?>
                                                        <li><a href="shop.php?subCategoryId=<?php echo $b["id"]; ?>">  <?php  echo $b["name_en"];    ?>   </a></li>
